...
class toUnicode {
   ...
   * //> "1f43c"
   */
  static fromCharacter(character: string): string {
   ...
   * //> [ '1f389', '20', '1f44b' ]
   */
  static fromString(characters: string, prefix: string = ''): string[] {
    return [...characters].reduce((accumulator: string[], character: string) => {
